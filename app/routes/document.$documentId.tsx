...
export const loader = async ({ params }: { params: { documentId: string } }) => {
  ...
  const transcription = document.DocumentTranscription
    .sort((a, b) => b.version - a.version)[0]?.document_representation || ''
...
export default function DocumentPage() {
  const { document, messages, transcription, prevId, nextId } = useLoaderData<typeof loader>()
